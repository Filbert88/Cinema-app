        ...
        <div className="w-full h-20 flex items-center justify-between px-20 fixed z-[999px] bg-black">
            ...
            >
                ...
                <div className="flex flex-col items-center gap-6 justify-center xl:flex-row">
                    {paths.map((path)=> (
                        <Link className="text-xl font-bold" href={path.url}>{path.name}</Link>
                    ))}
                </div>
                <div className="flex flex-col xl:flex-row gap-6 justify-center items-center">
                    <button className="px-5 py-3 rounded-xl bg-black xl:bg-red  font-bold text-xl">Log In</button>
                    <button className="px-5 py-3 rounded-xl bg-black xl:bg-red font-bold text-xl">Sign up</button>
                </div>
            </div>
        </div>
    )
